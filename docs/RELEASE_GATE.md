...
- صفحات واقعی مشتریان، فرصت‌ها و اعتراض‌ها، تیم فروش، مربیگری، گزارش‌ها و جست‌وجوی مکالمات
- اجرای جست‌وجوی فارسی از رابط تا API و نمایش حالت نتیجه خالی بدون داده ساختگی
